...
var
  ...
  aPaciente: TPaciente;
begin
  aPaciente := TPaciente.Create('111', 'Tiago', 'Oftalmologista');
...
begin
  ...
  CheckEquals('Tiago', aPaciente.Nome, 'Nome errado');
  ...
  CheckEquals('Tiago', FListaPaciente.PacienteAnterior.Nome, 'Nome Anterior errado');
